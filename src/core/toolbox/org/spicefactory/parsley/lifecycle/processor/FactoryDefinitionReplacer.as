...
public class FactoryDefinitionReplacer implements ObjectDefinitionReplacer {
	 ...
	 */
	function FactoryDefinitionReplacer (method:Method, registry:ObjectDefinitionRegistry) {
		this.method = method;
	...
	public function replace (definition:ObjectDefinition) : ObjectDefinition {
		...
		var builder:ObjectDefinitionBuilder = registry.builders.forClass(method.returnType.getClass());	
		
		builder.instantiate(new FactoryMethodInstantiator(factoryDefinition, method));
