 ...
 * @author Jens Halm
 */
public interface ObjectProcessorBuilder {
	 ...
	 */
	function initIn (phase: InitPhase) : ObjectProcessorBuilder;
	 ...
	 * @return this builder instance for method chaining
	 */
	function destroyIn (phase: DestroyPhase) : ObjectProcessorBuilder;
	
	/**
	 * Specifies the required type of the target instance configured by this processor.
	 * 
	 * @param type the required type of the target instance configured by this processor
	 * @return this builder instance for method chaining
	 */
	function expectType (type: Class) : ObjectProcessorBuilder;
