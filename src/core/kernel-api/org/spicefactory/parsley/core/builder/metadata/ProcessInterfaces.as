...
/**
 * Metadata tag that can be used on classes where the framework should process metadata on all interfaces
 * implemented by the class. The Flash Player does not automatically inherit metadata tags on interfaces,
